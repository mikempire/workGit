...
/* harmony import */ var _components_noUiSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/noUiSlider */ "./src/js/components/noUiSlider.js");
...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"](_vars__WEBPACK_IMPORTED_MODULE_0__["default"].swiperEl, {
  slidesPerView: 'auto',
  loop: true,
  navigation: {
...
swiper.on('transitionEnd', function () {
  var videos = document.querySelectorAll('.slide--one video');
  videos.forEach(function (el) {
    el.pause();
    el.currentTime = 0;
  });
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].playButtonsFirst.forEach(function (el) {
    el.style.display = 'block';
  });
});
_vars__WEBPACK_IMPORTED_MODULE_0__["default"].playButtonsFirst.forEach(function (el) {
  el.addEventListener('click', function (e) {
    var video = e.currentTarget.closest('.swiper-slide').querySelector('video');
    video.play();
...
var scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_4___default())('a[href*="#"]'); // Подключение событий свайпа на мобильных
...
var rules1 = [{
  ruleSelector: '.form--sample__input--name',
  rules: [{
    rule: 'minLength',
    value: 3,
  ...
  ruleSelector: '.form--sample__input--tel',
  tel: true,
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_5__.validateForms)('.sample__form', rules1, afterForm); //

var rules2 = [{
  ruleSelector: '.price-input__name',
  rules: [{
    rule: 'minLength',
    value: 3,
    errorMessage: 'Имя минимум 3 символа'
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_5__.validateForms)('.price__form', rules2, afterForm2);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  playButtonsFirst: document.querySelectorAll('.slide--one__play'),
...
if (rangeSlider) {
  ...
  var input1 = document.getElementById('input-0'); // 2й input убрал
...
document.querySelector('.call__btn').addEventListener('click', function (event) {
  event.preventDefault();
...
_vars__WEBPACK_IMPORTED_MODULE_1__["default"].callBtn.forEach(function (el) {
